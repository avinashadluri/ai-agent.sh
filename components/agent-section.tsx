      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <p className="max-w-[700px] text-zinc-400 md:text-xl/relaxed">
            AI Agents are autonomous systems that can understand, decide, and
            act to solve complex tasks.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:gap-12">
          <div className="flex flex-col space-y-6">
            <div className="space-y-6">
              ...
              <p className="text-zinc-400">
                Unlike simple automation tools, AI Agents can analyze context,
            ...
            <div className="space-y-6">
              ...
              <p className="text-zinc-400">
                Agents can orchestrate complex workflows, integrating with tools
                and services to accomplish multi-step tasks that would otherwise
            ...
            <div className="space-y-6">
              ...
              <p className="text-zinc-400">
                Through tool use and integration with external systems, agents
                can be extended with new capabilities beyond their initial
                programming.
              </p>
            </div>
            ...
            <Button
              variant="link"
              className="w-fit gap-1 text-primary hover:text-primary/90 px-0"
            >
          ...
          <div className="relative rounded-xl border border-zinc-800 bg-zinc-950 p-1">
            ...
            <div className="group relative overflow-hidden rounded-lg border border-zinc-800 bg-black">
              ...
              <div className="p-6">
                <Image
                  src="/robo1.png?height=400&width=500"
                  width={500}
                  height={400}
